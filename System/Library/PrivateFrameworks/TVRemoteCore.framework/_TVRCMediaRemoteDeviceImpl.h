...
@class _TVRXDevice, _TVRCMRTelevisionWrapper, _TVRCMROriginWrapper, NSSet, _TVRCMediaRemoteEventTranslator, _TVRXVoiceRecorder, NSMutableArray, _TVRXKeyboardController, NSString;
...
@property (nonatomic,retain) id<_TVRXKeyboardImpl> keyboardImpl;                             //@synthesize keyboardImpl=_keyboardImpl - In the implementation block
...
-(id<_TVRXKeyboardImpl>)keyboardImpl;
-(void)setKeyboardImpl:(id<_TVRXKeyboardImpl>)arg1 ;
