...
@interface SXAVPlayer : AVPlayer <AVPlayerItemDelegate> {
	...
	SCD_Struct_SX16 _cumulativeTimePlayed;
...
@property (assign,nonatomic) SCD_Struct_SX16 cumulativeTimePlayed;                        //@synthesize cumulativeTimePlayed=_cumulativeTimePlayed - In the implementation block
...
-(SCD_Struct_SX16)cumulativeTimePlayed;
-(void)updateTime:(SCD_Struct_SX16)arg1 duration:(SCD_Struct_SX16)arg2 ;
-(void)setCumulativeTimePlayed:(SCD_Struct_SX16)arg1 ;
