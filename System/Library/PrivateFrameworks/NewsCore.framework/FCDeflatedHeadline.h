...
@class NSString, NSDate, FCHeadlineThumbnail, NSURL, NSArray, FCCoverArt, NSSet, FCFeedPersonalizedArticleScoreProfile, FCTopStoriesStyleConfiguration, NSData, FCHeadlineExperimentalTitleMetadata, NTPBFeedViewportHeadline, FCSharedStringIndex, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort;
