...
+ (_Bool)isAvailableForConfiguration;	// IMP=0x0000000100225b44
+ (unsigned long long)requiredCapabilities;	// IMP=0x0000000100225b3c
+ (Class)isolationViewControllerClass;	// IMP=0x0000000100225af4
