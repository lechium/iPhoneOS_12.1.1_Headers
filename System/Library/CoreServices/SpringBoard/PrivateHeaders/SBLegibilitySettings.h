...
+ (id)settingsControllerModule;	// IMP=0x0000000100011398
...
- (double)userPictureStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011ddc
- (double)logoutButtonTextStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011dac
- (double)logoutButtonGlyphStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011d7c
- (double)timerDialStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011d4c
- (double)timerTextStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011d1c
- (double)folderTitleStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011cec
- (double)iconLabelStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011cbc
- (double)statusTextStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011c8c
- (double)dateStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011c5c
- (double)timeStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011c2c
- (double)appIconGrabberStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011bfc
- (double)slideToUnlockStrengthForStyle:(long long)arg1;	// IMP=0x0000000100011bcc
- (void)setDefaultValues;	// IMP=0x0000000100011178
