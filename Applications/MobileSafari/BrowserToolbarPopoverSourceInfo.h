...
- (void).cxx_destruct;	// IMP=0x0000000100018334
@property(readonly, nonatomic) UIView *popoverSourceView;
@property(readonly, nonatomic) struct CGRect popoverSourceRect;
- (id)_sourceInfo;	// IMP=0x00000001000181fc
- (id)initWithBrowserController:(id)arg1 barItem:(long long)arg2;	// IMP=0x0000000100018150
