...
- (void).cxx_destruct;	// IMP=0x000000010005f6b8
- (id)jsonBodyDictionary;	// IMP=0x000000010005f2b4
- (id)path;	// IMP=0x000000010005f220
- (id)initWithDevice:(id)arg1;	// IMP=0x000000010005f1b0
