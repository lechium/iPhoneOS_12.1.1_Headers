...
- (void).cxx_destruct;	// IMP=0x0000000100076ab8
- (id)detailSectionForRow:(long long)arg1 column:(long long)arg2;	// IMP=0x000000010007626c
- (id)mainSection;	// IMP=0x0000000100075fc0
- (long long)numberOfColumnsForRow:(long long)arg1;	// IMP=0x0000000100075f00
- (long long)numberOfRows;	// IMP=0x0000000100075ec8
- (id)initWithSleepAnalysis:(id)arg1;	// IMP=0x0000000100075dc4
