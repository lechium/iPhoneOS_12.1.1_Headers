...
- (void).cxx_destruct;	// IMP=0x00000001000779d0
- (id)detailSectionForRow:(long long)arg1 column:(long long)arg2;	// IMP=0x0000000100076f44
- (id)mainSection;	// IMP=0x0000000100076c24
- (long long)numberOfColumnsForRow:(long long)arg1;	// IMP=0x0000000100076c18
- (long long)numberOfRows;	// IMP=0x0000000100076c10
- (id)initWithSleepAnalysis:(id)arg1;	// IMP=0x0000000100076b0c
