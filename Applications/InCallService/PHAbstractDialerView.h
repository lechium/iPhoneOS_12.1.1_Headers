...
- (void).cxx_destruct;	// IMP=0x000000010008e030
- (void)dialerField:(id)arg1 senderIdentityWasTapped:(id)arg2;	// IMP=0x000000010008de5c
- (void)dialerField:(id)arg1 stringWasPasted:(id)arg2;	// IMP=0x000000010008ddc0
- (void)dialerLCDFieldTextDidChange:(id)arg1;	// IMP=0x000000010008dd44
- (void)dealloc;	// IMP=0x000000010008dce8
