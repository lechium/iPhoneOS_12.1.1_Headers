...
- (void).cxx_destruct;	// IMP=0x000000010004aad0
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010004aa70
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000010004a790
